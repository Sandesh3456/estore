...
const Cart = () => {
  ...
  const removeCartHandle = (id, title) => {
    const confirmRemoval = window.confirm(`Are you sure you want to remove ${title} from the cart?`);
    if (confirmRemoval) {
      const filteredCart = product.filter(item => item.id !== id);
  ...
  <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
    ...
    <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
      <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
        ...
        {product.length === 0 ? (
    <h2 className='mt-4 text-center text-2xl'>Cart is empty</h2>
) : (
    <>
       {product.map((item)=>
            ...
            <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
              ...
              <div className="flex items-center justify-between md:order-3 md:justify-end">
                <div className="flex items-center">
                  ...
                  <input type="text" id="counter-input-5" data-input-counter className="w-10 shrink-0 border-0 bg-transparent text-center text-sm font-medium text-gray-900 focus:outline-none focus:ring-0 dark:text-white" placeholder="" value={item.quantity} required />
                  <button type="button"
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <dl className="flex items-center justify-between gap-4">
                ...
                <dd className="text-base font-medium text-gray-900 dark:text-white">{product.reduce((ac,item)=>(ac+Number(item.quantity)),0)}</dd>
              </dl>
            ...
            <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
              ...
              <dd className="text-base font-bold text-gray-900 dark:text-white">{product.reduce((ac,item)=>(ac+Number(item.quantity*item.price)),0)}</dd>
            </dl>
          </div>
